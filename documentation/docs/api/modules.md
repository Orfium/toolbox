...
[src/routing/Routing.tsx:14](https://github.com/Orfium/toolbox/blob/2074d49/src/routing/Routing.tsx#L14)
...
[src/request/createAPIInstance.ts:6](https://github.com/Orfium/toolbox/blob/2074d49/src/request/createAPIInstance.ts#L6)
...
| `createRequest` | <T\>(`props`: [`RequestProps`](modules.md#requestprops-18)) => { `cancelTokenSource`: [`CancelTokenSource`](interfaces/CancelTokenSource.md) ; `request`: () => `Promise`<`T`\> } |
| `deleteToken`   | () => `void`                                                                                                                                                                      |
| `setToken`      | (`token`: `string`) => `void`                                                                                                                                                     |

#### Defined in

[src/request/createAPIInstance.ts:11](https://github.com/Orfium/toolbox/blob/2074d49/src/request/createAPIInstance.ts#L11)
...
[src/routing/Routing.tsx:22](https://github.com/Orfium/toolbox/blob/2074d49/src/routing/Routing.tsx#L22)
...
[src/request/mock.ts:3](https://github.com/Orfium/toolbox/blob/2074d49/src/request/mock.ts#L3)

---

### RequestProps

Ƭ **RequestProps**: { `headers?`: `Record`<`string`, `unknown`\> ; `method`: `string` ; `params?`: `Record`<`string`, `unknown`\> ; `url`: `string` ; `withoutBase?`: `boolean` } & `Pick`<[`AxiosRequestConfig`](interfaces/AxiosRequestConfig.md), `"onUploadProgress"` \| `"onDownloadProgress"` \| `"responseType"`\>

#### Defined in

[src/request/request.ts:13](https://github.com/Orfium/toolbox/blob/2074d49/src/request/request.ts#L13)
...
[src/routing/Routing.tsx:35](https://github.com/Orfium/toolbox/blob/2074d49/src/routing/Routing.tsx#L35)
...
[src/routing/Routing.tsx:41](https://github.com/Orfium/toolbox/blob/2074d49/src/routing/Routing.tsx#L41)
...
[src/routing/Routing.tsx:24](https://github.com/Orfium/toolbox/blob/2074d49/src/routing/Routing.tsx#L24)
...
[src/request/request.ts:11](https://github.com/Orfium/toolbox/blob/2074d49/src/request/request.ts#L11)
...
[src/request/mock.ts:4](https://github.com/Orfium/toolbox/blob/2074d49/src/request/mock.ts#L4)
...
[src/request/createAPIInstance.ts:28](https://github.com/Orfium/toolbox/blob/2074d49/src/request/createAPIInstance.ts#L28)
...
| `props.structure`          | [`RoutingStructure`](modules.md#routingstructure-20) | The component that will render if none of the routes match the url location          |
...
[src/routing/Routing.tsx:62](https://github.com/Orfium/toolbox/blob/2074d49/src/routing/Routing.tsx#L62)
