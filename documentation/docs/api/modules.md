...
- [generateRoutes](modules.md#generateroutes-16)
...
[src/routing/Routing.tsx:14](https://github.com/Orfium/toolbox/blob/2121dd5/src/routing/Routing.tsx#L14)
...
[src/routing/Routing.tsx:22](https://github.com/Orfium/toolbox/blob/2121dd5/src/routing/Routing.tsx#L22)
...
[src/request/mock.ts:3](https://github.com/Orfium/toolbox/blob/2121dd5/src/request/mock.ts#L3)
...
[src/routing/Routing.tsx:35](https://github.com/Orfium/toolbox/blob/2121dd5/src/routing/Routing.tsx#L35)
...
| :--------------- | :------------------------------------------------------------------------------------- | :--------------------------------------------------------------------------------------------------------------------------------- |
| `authorization?` | [`Authorization`](modules.md#authorization-16)                                         | The authorization level of the route, there are 3: 'anonymous' \| 'authorized' \| 'unauthorized' - **`defaultvalue:`** 'anonymous' |
| `component?`     | `React.FunctionComponent`<[`RouteComponentProps`](modules.md#routecomponentprops-16)\> | A component that the route renders as page. This has all the props and extraProps that have been passed to that route              |
...
[src/routing/Routing.tsx:41](https://github.com/Orfium/toolbox/blob/2121dd5/src/routing/Routing.tsx#L41)
...
| Name             | Type                                                                          | Description                                                                                                                                                                               |
| :--------------- | :---------------------------------------------------------------------------- | :---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `fallbackPaths?` | `Partial`<`Record`<[`FallbackPath`](modules.md#fallbackpath-16), `string`\>\> | Holder of paths relative to the types of authorization. For every type there is a fallback path that a user will be redirected if they don't have access to it based on the authorization |
| `routes`         | [`RouteItem`](modules.md#routeitem-16)[]                                      | -                                                                                                                                                                                         |

#### Defined in

[src/routing/Routing.tsx:24](https://github.com/Orfium/toolbox/blob/2121dd5/src/routing/Routing.tsx#L24)
...
[src/request/index.ts:12](https://github.com/Orfium/toolbox/blob/2121dd5/src/request/index.ts#L12)
...
[src/request/mock.ts:4](https://github.com/Orfium/toolbox/blob/2121dd5/src/request/mock.ts#L4)
...
| `props.structure`          | [`RoutingStructure`](modules.md#routingstructure-16) | A list of Routes that needs to render with authorization level and extra props.                                  |
...
[src/routing/Routing.tsx:62](https://github.com/Orfium/toolbox/blob/2121dd5/src/routing/Routing.tsx#L62)
